...
// Implements core gRPC methods: HealthCheck, ExecuteCommand, StartProcess, PostFileStream, GetFileStream
package guestd
...
func (s *AgentServer) ExecuteCommand(ctx context.Context, req *pb.CommandRequest) (*pb.CommandResponse, error) {
	...
	stdout, stderr, _, err := s.executeCmd(ctx, req.Command, req.Args, "", nil)
