...
// E2BConfig enables the TCP Node API; APIKey is resolved from AENV_API_KEY.
...
// ClusterConfig identifies this Node to the Scheduler; an empty
// SchedulerAddr disables reporting.
